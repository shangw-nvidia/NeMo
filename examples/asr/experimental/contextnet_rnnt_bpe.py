...
def create_all_dags(args, neural_factory):
    ...
    train_callback = nemo.core.SimpleLossLoggerCallback(
        ...
        print_func=partial(
            monitor_transducer_asr_train_progress, tokenizer=tokenizer, decoder_type='static', eval_metric='WER'
        ),
    ...
    for i, eval_dl in enumerate(data_layers_eval):
        ...
        eval_callback = nemo.core.EvaluatorCallback(
            ...
            user_iter_callback=partial(
                process_transducer_evaluation_batch, tokenizer=tokenizer, decoder_type='static', beam_size=args.beam_size
            ),
