...
import nemo_nlp
import nemo_nlp.data.datasets.sgd_utils as sgd_utils
from nemo_nlp.data.datasets.sgd_utils import StateTrackingSGDDataDesc
...
parser.add_argument("--data_dir", default='data/statetracking/sgd', type=str)
parser.add_argument("--dataset_name", default='sgd', type=str)
parser.add_argument("--task_name", default='dstc8_all', type=str)
...
data_desc = StateTrackingSGDDataDesc(args.data_dir,
									 tokenizer,
									 task_name=task_name,
