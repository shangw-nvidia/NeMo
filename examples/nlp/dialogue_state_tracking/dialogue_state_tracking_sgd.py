...
parser.add_argument(
    "--enable_pin_memory", action="store_true", help="Enables the pin_memory feature of Pytorch's DataLoader",
)
...
dst_loss = nemo_nlp.nm.losses.SGDDialogueStateLoss(add_carry_status=args.add_carry_status)
